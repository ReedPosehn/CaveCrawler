...
mob* initMobs()
{
	...
	mobs[0].maxDmg = 2;
	mobs[0].drop = 0;
	mobs[0].desc = "A slimy green goblin, wearing rags and wielding a rusty scimitar.\n";
	mobs[0].name = "Goblin";
...
{
	mob currMob = mobs[mobRng];
	//cout << "Current Mob health: " << currMob.health << endl;
	//cout << "Current Mob name: " << currMob.name << endl;
	return currMob;
}